...
class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.leftButton.setDepth(1000); // make sure the button is on top
        
        // add specific click handling for the button
        this.leftButton.on('pointerdown', (pointer, localX, localY, event) => {
            // prevent event from propagating to other parts of the scene
            if (event && event.stopPropagation) {
                event.stopPropagation();
            }
            console.log('Left button clicked');
            
            // check if there are balls on the screen
        ...
        this.rightButton.setDepth(1000); // make sure the button is on top
        ...
        leftText.setDepth(1001); // make sure the text is on top of the button
        ...
        rightText.setDepth(1001); // make sure the text is on top of the button
